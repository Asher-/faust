 ...
 */
void CodeContainer::openLoop(const std::string& index_name, int size)
{
 ...
 * @param size the number of iterations of the loop
 */
void CodeContainer::openLoop(Tree recsymbol, const std::string& index_name, int size)
{
...
ValueInst* CodeContainer::pushFunction(const std::string& name, Typed::VarType result, vector<Typed::VarType>& types,
                                       const Values& args)
{
    Names named_args;
...
void CodeContainer::produceInfoFunctions(int tabs, const std::string& classname, const std::string& obj, bool ismethod,
                                         FunTyped::FunAttribute funtype, TextInstVisitor* producer,
                                         const std::string& in_fun, const std::string& out_fun)
{
    // Input/Output method
    producer->Tab(tabs);
...
DeclareFunInst* CodeContainer::generateGetIO(const std::string& name, const std::string& obj, int io, bool ismethod,
...
DeclareFunInst* CodeContainer::generateGetInputs(const std::string& name, const std::string& obj, bool ismethod, FunTyped::FunAttribute funtype)
{
    return generateGetIO(name, obj, fNumInputs, ismethod, funtype);
}

DeclareFunInst* CodeContainer::generateGetOutputs(const std::string& name, const std::string& obj, bool ismethod, FunTyped::FunAttribute funtype)
{
    return generateGetIO(name, obj, fNumOutputs, ismethod, funtype);
}

DeclareFunInst* CodeContainer::generateAllocate(const std::string& name, const std::string& obj, bool ismethod, bool isvirtual)
{
    Names args;
    if (!ismethod) {
        args.push_back(InstBuilder::genNamedTyped(obj, Typed::kObj_ptr));
...
DeclareFunInst* CodeContainer::generateDestroy(const std::string& name, const std::string& obj, bool ismethod, bool isvirtual)
{
    Names args;
    if (!ismethod) {
        args.push_back(InstBuilder::genNamedTyped(obj, Typed::kObj_ptr));
...
DeclareFunInst* CodeContainer::generateGetIORate(const std::string& name, const std::string& obj, vector<int>& io, bool ismethod,
                                                 bool isvirtual)
{
    Names args;
    if (!ismethod) {
...
DeclareFunInst* CodeContainer::generateInstanceClear(const std::string& name, const std::string& obj, bool ismethod,
                                                     bool isvirtual)
{
    Names args;
    if (!ismethod) {
...
DeclareFunInst* CodeContainer::generateInstanceConstants(const std::string& name, const std::string& obj, bool ismethod,
                                                        bool isvirtual)
{
    Names args;
    if (!ismethod) {
...
DeclareFunInst* CodeContainer::generateStaticInitFun(const std::string& name, bool isstatic)
{
    Names args;
    args.push_back(InstBuilder::genNamedTyped("sample_rate", Typed::kInt32));
...
DeclareFunInst* CodeContainer::generateInstanceInitFun(const std::string& name, const std::string& obj, bool ismethod,
                                                       bool isvirtual)
{
    Names args;
    if (!ismethod) {
...
DeclareFunInst* CodeContainer::generateFillFun(const std::string& name, const std::string& obj, bool ismethod, bool isvirtual)
{
    Names args;
    if (!ismethod) {
        args.push_back(InstBuilder::genNamedTyped(obj, Typed::kObj_ptr));
...
DeclareFunInst* CodeContainer::generateInit(const std::string& name, const std::string& obj, bool ismethod, bool isvirtual)
{
    Names args;
    if (!ismethod) {
        args.push_back(InstBuilder::genNamedTyped(obj, Typed::kObj_ptr));
...
DeclareFunInst* CodeContainer::generateInstanceInit(const std::string& name, const std::string& obj, bool ismethod,
                                                    bool isvirtual)
{
    Names args;
    if (!ismethod) {
...
DeclareFunInst* CodeContainer::generateGetSampleRate(const std::string& name, const std::string& obj, bool ismethod,
                                                     bool isvirtual)
{
    Names args;
    if (!ismethod) {
...
DeclareFunInst* CodeContainer::generateComputeFun(const std::string& name, const std::string& obj, bool ismethod, bool isvirtual)
{
    Names args;
    if (!ismethod) {
        args.push_back(InstBuilder::genNamedTyped(obj, Typed::kObj_ptr));
...
DeclareFunInst* CodeContainer::generateNewDsp(const std::string& name, int size)
{
    Names args;
...
DeclareFunInst* CodeContainer::generateDeleteDsp(const std::string& name, const std::string& obj)
{
    Names args;
    args.push_back(InstBuilder::genNamedTyped(obj, Typed::kObj_ptr));
