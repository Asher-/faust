...
#ifndef __FAUST__PRIMITIVE__MATH__ASIN__HH__
#define __FAUST__PRIMITIVE__MATH__ASIN__HH__
...
namespace Faust {
  namespace Primitive {
    namespace Math {
      ...
      class Asin : public ::Faust::Primitive::Math::xtended {
          public:
          static Asin* self;
          Asin() : ::Faust::Primitive::Math::xtended("asin") {}
