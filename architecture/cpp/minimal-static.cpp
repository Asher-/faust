...
/*
faust -uim -a minimal-static.cpp noise.dsp -o noise.cpp && c++ -std=c++17 noise.cpp -o noise && ./noise
faust -uim -a minimal-static.cpp clarinetMIDI.dsp -o clarinetMIDI.cpp && c++ -std=c++17 clarinetMIDI.cpp -o clarinetMIDI && ./clarinetMIDI
faust -uim -a minimal-static.cpp vumeter.dsp -o vumeter.cpp && c++ -std=c++17 vumeter.cpp -o vumeter && ./vumeter
*/
