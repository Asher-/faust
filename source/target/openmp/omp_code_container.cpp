...
struct StackVarAnalyser : public DispatchVisitor {
    list<std::string> fFirstPrivateTable;
...
void OpenMPCodeContainer::generateLocalInputs(BlockInst* loop_code, const std::string& index)
{
...
void OpenMPCodeContainer::generateLocalOutputs(BlockInst* loop_code, const std::string& index)
{
...
StatementInst* OpenMPCodeContainer::generateDAGLoopOMP(const std::string& counter)
{
