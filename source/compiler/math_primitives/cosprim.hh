...
#ifndef __FAUST__PRIMITIVE__MATH__COS__HH__
#define __FAUST__PRIMITIVE__MATH__COS__HH__
...
namespace Faust {
  namespace Primitive {
    namespace Math {
      ...
      class Cos : public ::Faust::Primitive::Math::xtended {
          public:
          static Cos* self;
          Cos() : ::Faust::Primitive::Math::xtended("cos") {}
