...
void WSSCodeContainer::moveCompute2ComputeThread()
{
    ...
    struct Compute2ComputeThread : public DispatchVisitor {
        ...
        Compute2ComputeThread(WSSCodeContainer* container, vector<std::string> variables) : fContainer(container), fVariables(variables) {}
    };
...
void WSSCodeContainer::generateDAGLoopWSSAux2(lclgraph dag, const std::string& counter)
{
    string     index     = "fIndex";
...
void WSSCodeContainer::generateLocalInputs(BlockInst* loop_code, const std::string& index_string)
{
...
void WSSCodeContainer::generateLocalOutputs(BlockInst* loop_code, const std::string& index_string)
{
...
DeclareFunInst* WSSCodeContainer::generateComputeThread(const std::string& name, const std::string& obj, bool ismethod,
                                                        bool isvirtual)
{
    Names args;
    if (!ismethod) {
...
DeclareFunInst* WSSCodeContainer::generateComputeThreadExternal(const std::string& name, const std::string& obj)
{
    Names args;
